...
For each resolver, support the listed media and link types, add fixtures and declare
media kinds. Include login support where needed. All platform checks must pass.
